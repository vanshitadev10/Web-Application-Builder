...
<div class="container py-4" style="max-width:100%;">
  <ul class="list-group list-group-horizontal" style="display:grid; grid-template-columns:1fr 1fr 1fr; border:1px solid black; text-align:{{textAlignment}};">
    <li class="list-group-item font-weight-bold" style="border:1px solid black;">{{item1}}</li>
    <li class="list-group-item font-weight-bold" style="border:1px solid black;">{{item2}}</li>
    <li class="list-group-item font-weight-bold" style="border:1px solid black;">{{item3}}</li>
  </ul>
...
const block = {
  hbs,
  name: 'List #4',
  previewImageUrl: 'https://i.imgur.com/GOsilra.png',
  category: 'list',
  defaultData: {
    item1: "Item 1",
    item2: "Item 2",
