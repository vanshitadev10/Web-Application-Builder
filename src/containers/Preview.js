    ...
    <div className={`preview-window shadow-lg preview-mode-${props.previewMode}`}>
      <div className='preview-toolbar d-flex align-items-center justify-content-between'>
        <div className='d-flex align-items-center'>
          <span className="material-icons preview-toolbar-dot" style={{ color: '#f65314' }}>circle</span>
          <span className="material-icons preview-toolbar-dot" style={{ color: '#ffbb00' }}>circle</span>
          <span className="material-icons preview-toolbar-dot" style={{ color: '#7cbb00' }}>circle</span>
        </div>
